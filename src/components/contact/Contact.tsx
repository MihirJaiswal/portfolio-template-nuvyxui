...
const ContactForm: React.FC<ContactFormProps> = ({ onSubmit }) => {
  ...
  return (
    <div className="flex items-center justify-center gap-20 md:h-[93vh] relative w-full  overflow-hidden  bg-gradient-to-r from-blue-500 via-purple-500 to-pink-200 dark:bg-gradient-to-r dark:from-pink-800 xl:dark:from-purple-900 dark:via-purple-800 xl:dark:via-gray-600 dark:to-[#4b5172] xl:dark:to-[#4b5172] ">
