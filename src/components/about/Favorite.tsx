              ...
              <div>
                <div className="flex flex-col md:flex-row justify-between items-start p-4">
                  ...
                  {active.ctaLink && (
                    ...
                    href={active.ctaLink}
                    target="_blank"
                    className="md:px-4 py-3 text-sm rounded-full font-bold md:bg-pink-500 md:dark:bg-purple-500 text-pink-500 md:text-white dark:text-white underline md:no-underline decoration-double"
                  >
                    {active.ctaText}
                  </motion.a>
                  )}
