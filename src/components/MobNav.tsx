...
const MobNav = () => {
  ...
  return (
    <div className='md:hidden'>
      ...
      {
        isOpen && (
          <div className='absolute left-0 top-24 w-full h-[calc(100vh-96px)] bg-white flex flex-col items-center justify-center gap-8 font-medium text-black text-xl'>
            <Link href="/">Home</Link>
            <Link href="/freinds">Freinds</Link>
